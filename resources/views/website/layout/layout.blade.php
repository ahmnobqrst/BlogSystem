    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-2 px-lg-5">
            ...
            <div class="col-lg-8 text-center text-lg-right">
                <img class="img-fluid" src="{{asset($settings->logo)}}" alt="">
            </div>
        </div>
    </div>
    </div>
                ...
                <div class="navbar-nav mr-auto py-0">
                    ...
                    @foreach($categories as $category)
                          <div class="nav-item dropdown">
                            <a @if(count($category->childern) == 0 ) href="{{route('category',$category->id)}}" @else href="#" @endif 
                                class="nav-link @if(count($category->childern) > 0) dropdown-toggle @endif"
                                @if(count($category->childern) > 0) data-toggle ="dropdown" @endif >{{$category->title}}</a>
            ...
            <div class="col-lg-6 col-md-6 mb-5">
                ...
                <div class="d-flex justify-content-start mt-4">
                    ...
                    @if($settings->facebook != '')
                       <a class="btn btn-outline-secondary text-center mr-2 px-0" style="width: 38px; height: 38px;" href="{{$settings->facebook}}">
                       <i class="fab fa-facebook-f"></i></a>
                    @endif


                    @if($settings->instagram != '')
                       <a class="btn btn-outline-secondary text-center mr-2 px-0" style="width: 38px; height: 38px;" href="{{$settings->instagram}}">
