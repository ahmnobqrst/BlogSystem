              ...
              @foreach(config('app.languages') as $key=>$lang)
                <div id="{{$key}}" class="tab-pane fade">
                    <div class="list-group">
                       ...
                       <input type="text" name="{{$key}}[title]" class="form-control" placeholder="{{trans('words.title')}}" value="{{$post->translate($key)->title}}">
                       @error('{{$key}}[title]')
                    ...
                    <div class="list-group">
                       ...
                       rows="10" >{{$post->translate($key)->content}}</textarea>
                       @error('{{$key}}[content]')
                       <span class="alert alert-danger alert-dismissible">{{ $message }}</span>
                       @enderror 
                    </div>
                    <div class="list-group">
                       ...
                       rows="10" >{{$post->translate($key)->smalldesc}}</textarea>
                       @error('{{$key}}[smallDesc]')
                       <span class="alert alert-danger alert-dismissible">{{ $message }}</span>
                       @enderror 
                    </div>
                    <div class="list-group">
                       ...
                       <textarea type="text" name="{{$key}}[tags]" class="form-control" id="" placeholder="{{__('words.tags')}}" >{{$post->translate($key)->tags}}</textarea>
                       @error('{{$key}}[tags]')
                       <span class="alert alert-danger alert-dismissible">{{ $message }}</span>
                       @enderror 
                    </div>
